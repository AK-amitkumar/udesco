# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-07-29 18:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('erpid', models.IntegerField(blank=True, null=True)),
                ('subs_erpid', models.IntegerField(blank=True, null=True)),
                ('state', models.CharField(choices=[('draft', 'Draft'), ('downpay', 'Downpay'), ('late', 'Late'), ('normal', 'Normal'), ('defaulted', 'Defaulted'), ('repo', 'Repossessed'), ('paid', 'Paid'), ('cancel', 'Cancel')], default='draft', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('erpid', models.IntegerField(blank=True, null=True)),
                ('start_date', models.DateTimeField(default=datetime.datetime(2017, 7, 29, 18, 18, 13, 934261))),
                ...
                ('crm', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='shop.CRM')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('erpid', models.IntegerField(blank=True, null=True)),
                ('state', models.CharField(choices=[('draft', 'Draft'), ('open', 'Open'), ('paid', 'Paid'), ('cancel', 'Cancel')], default='draft', max_length=200)),
                ('crm', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='shop.CRM')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('product_erpid', models.IntegerField(blank=True, null=True)),
                ('template_erpid', models.IntegerField(blank=True, null=True)),
                ('name', models.CharField(max_length=200)),
                ('default_code', models.CharField(max_length=200)),
                ('list_price', models.FloatField(default=0)),
                ('type', models.CharField(blank=True, choices=[('service', 'Service'), ('stock', 'Stockable'), ('consu', 'Consumable')], max_length=200, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Shop',
