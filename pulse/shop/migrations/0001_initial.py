# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-07-05 18:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('erpid', models.IntegerField(unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('start_date', models.DateTimeField(default=datetime.datetime(2017, 7, 5, 18, 35, 54, 342889))),
